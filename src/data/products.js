export const products = [
 ...
 
  {
    ...
    price: 42.99,
    title: 'Olive Cargo Pant'
  },
  {
    id: '3',
    brand: 'Adidas',
    description: 'Welcome to a new age of originality. Inspired by the adidas Originals-owned NFT, the Indigo Herz Drop is an invitation to self-express without limitations. No matter which world you\'re in.  Hoodies are comfy, but even great things can get better. The adidas Indigo Herz Fur Hoodie levels up the cozy factor with faux fur that\'s inspired by its namesake and peach-soft to the touch. Classic details — like a hood and the iconic 3-Stripes — create a signature silhouette that easily pairs with everything in your wardrobe.',
    ...
    price: 52.99,
    title: 'Herz Fur Hoodie'
  },
  {
    id: '4',
    brand: 'Jack & Jones',
    description: 'The Jack & Jones Denim Jacket is a classic piece that will never go out of style. It\'s made from durable denim and features a comfortable fit. This jacket is perfect for everyday wear and can be dressed up or down. It\'s also a great layering piece for the colder months. The jacket is made from 100% cotton denim and has a regular fit. It has a button-down closure and two front pockets and two chest pockets. It is available in a variety of colors, including blue, black, and white.',
  ...
  },
  {
    id: '5',
    brand: 'Zaara',
    description: 'Zara\'s tank top pant is a versatile and comfortable piece that can be dressed up or down. It\'s made from a soft, breathable fabric that will keep you cool and comfortable all day long. The tank top style is flattering on all body types, and the pant length is perfect for a variety of occasions.',
  ...
  },
  {
    id: '6',
    brand: 'Zued Simon',
    description: 'Zued Simon\'s trending outfit is a stylish and comfortable ensemble that is perfect for any occasion.  This outfit is made with high-quality materials and features a flattering design that will make you look and feel your best.  Whether you\'re running errands, going out on the town, or just lounging around the house, Zued Simon\'s trending outfit is the perfect choice for you.',
  ...
  },
  {
    id: '9',
    brand: 'Roadster',
    description: 'Roadster is a popular brand of men\'s jeans that offers a variety of styles to suit different needs and occasions. Whether you\'re looking for a pair of jeans to wear to work, to the gym, or on a night out, Roadster has a style that\'s perfect for you.  Roadster jeans are made from high-quality denim that\'s both durable and comfortable. The jeans are also designed to flatter a variety of body types, so you\'re sure to find a pair that fits you perfectly.  In addition to their stylish designs, Roadster jeans are also known for their affordable prices. You can find a great pair of Roadster jeans for less than $200, making them a great option for budget-minded shoppers.',
